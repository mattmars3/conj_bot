...
pub fn serialize(verb_map: ConjugationList) -> String {
    let json_str = serde_json::to_string(&verb_map).unwrap();
    json_str
}

// writes String to json file
pub fn write_file(json_str: String, filename: String) {
...
pub fn deserialize(file_content: String) -> ConjugationList {
